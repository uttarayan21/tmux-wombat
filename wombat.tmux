...
theme() {
    ...
    tmux set -ga status-right "#[fg=colour235,bg=colour235,nobold,nounderscore,noitalics]${powerline_right_sep}#[fg=colour192,bg=colour235] #(echo $(battery state)) #(echo $(battery percent)) "         #day
