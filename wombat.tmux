...
theme() {
    ...
    tmux set -ga status-left "#[fg=colour232,bg=colour192] #S #[fg=colour192,bg=colour238,nobold,nounderscore,noitalics]${powerline_left_sep}" #session name
    ...
    tmux set -ga status-right "#[fg=colour235,bg=colour235,nobold,nounderscore,noitalics]${powerline_right_sep}#[fg=colour192,bg=colour235] #(acpi | cut -d: -f2- | cut -d, -f1) #(acpi | cut -d: -f2- | cut -d, -f2) "         #day
